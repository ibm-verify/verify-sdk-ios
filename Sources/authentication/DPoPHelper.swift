...
public enum DPoP {
    ...
    public static func generateProof(_ privateKey: RSA.Signing.PrivateKey, hashAlgorithm: any HashFunction = SHA256(), uri: String, method: HTTPMethod = .post, accessToken: String? = nil) throws -> String {
