...
final class BiometricFactorInfoTests: XCTestCase {
    ...
    func testFactorEncoding() throws {
        ...
        let expectedJSON = """
        {"algorithm":"sha256","id":"E851C813-A337-4D90-9E11-37E4B3141F3C","name":"Test-Biometric-Key"}
        """
...
final class FactorTypeTests: XCTestCase {
    ...
    func testCodableEncoding() throws {
        ...
        let expectedBioJSON = """
        {"biometric":{"algorithm":"sha256","id":"11111111-1111-1111-1111-111111111111","name":"Bio-Key"}}
        """
        ...
        let expectedUPJSON = """
        {"userPresence":{"algorithm":"sha512","id":"22222222-2222-2222-2222-222222222222","name":"User-Pres-Key"}}
        """
    ...
    func testCodableDecoding() throws {
        ...
        // .biometric decoding
        let bioJSON = "{\"biometric\":{\"algorithm\":\"sha256\",\"id\":\"11111111-1111-1111-1111-111111111111\",\"name\":\"Bio-Key\"}}"
        ...
        let upJSON = "{\"userPresence\":{\"algorithm\":\"sha512\",\"id\":\"22222222-2222-2222-2222-222222222222\",\"name\":\"User-Pres-Key\"}}"
